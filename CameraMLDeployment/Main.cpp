...
#include <CameraMLDeployment/Top/CameraMLDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    CameraMLDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    CameraMLDeployment::TopologyState inputs;
    ...
    CameraMLDeployment::setupTopology(inputs);
    CameraMLDeployment::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    //CameraMLDeployment::teardownTopology(inputs);
    //(void)printf("Exiting...\n");
    //return 0;
}
