// ======================================================================
// \title  CameraMLDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef CAMERAMLDEPLOYMENT_CAMERAMLDEPLOYMENTTOPOLOGY_HPP
#define CAMERAMLDEPLOYMENT_CAMERAMLDEPLOYMENTTOPOLOGY_HPP
// Included for access to CameraMLDeployment::TopologyState and CameraMLDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <CameraMLDeployment/Top/CameraMLDeploymentTopologyDefs.hpp>

// Remove unnecessary CameraMLDeployment:: qualifications
 ...
 * CameraMLDeployment::TopologyState see: CameraMLDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type CameraMLDeployment::TopologyState see: CameraMLDeploymentTopologyDefs.hpp.
 *
