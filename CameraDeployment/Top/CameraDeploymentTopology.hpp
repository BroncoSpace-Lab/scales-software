// ======================================================================
// \title  CameraDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef CAMERADEPLOYMENT_CAMERADEPLOYMENTTOPOLOGY_HPP
#define CAMERADEPLOYMENT_CAMERADEPLOYMENTTOPOLOGY_HPP
// Included for access to CameraDeployment::TopologyState and CameraDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <CameraDeployment/Top/CameraDeploymentTopologyDefs.hpp>

// Remove unnecessary CameraDeployment:: qualifications
 ...
 * CameraDeployment::TopologyState see: CameraDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type CameraDeployment::TopologyState see: CameraDeploymentTopologyDefs.hpp.
 *
